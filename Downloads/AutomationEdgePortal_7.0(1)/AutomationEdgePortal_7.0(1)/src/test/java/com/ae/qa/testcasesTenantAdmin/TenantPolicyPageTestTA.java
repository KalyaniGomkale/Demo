...
@Test(priority = 120)
	public void validatePswdComplexityTATest(Method method) throws Exception {
		...
		System.out.println("Values are: "+TestDataInMap.get("minLength") +TestDataInMap.get("maxLength")+
TestDataInMap.get("upperCase")+TestDataInMap.get("lowerCase")+TestDataInMap.get("specialChar")+TestDataInMap.get("digitsIp")+TestDataInMap.get("PSWDWoCriteria"));
		tenantpolicypageta.validatePswdComplexityTA(TestDataInMap.get("minLength"),TestDataInMap.get("maxLength"),
TestDataInMap.get("upperCase"),TestDataInMap.get("lowerCase"),TestDataInMap.get("specialChar"),TestDataInMap.get("digitsIp"),TestDataInMap.get("PSWDWoCriteria"));
