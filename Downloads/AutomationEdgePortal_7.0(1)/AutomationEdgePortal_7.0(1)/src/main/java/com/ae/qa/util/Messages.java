...
//Sysadmin specific messages
	...
	public static String transferSchedule="Schedules transfered successfully";
	...
	public static String permissions= "Permissions set successfully";
	...
	public static String editAgentName="Changes saved to the agent";
	public static String emailNotificationEnableOn="Notification configuration saved succefully";
